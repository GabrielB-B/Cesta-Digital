...
class Family(TimestampMixin, Base):
    ...
    monthly_income_total: Mapped[Decimal] = mapped_column(Numeric(12, 2), nullable=False, default=0)
    monthly_essential_expenses: Mapped[Decimal] = mapped_column(Numeric(12, 2), nullable=False, default=0)
    income_per_capita: Mapped[Decimal] = mapped_column(Numeric(12, 2), nullable=False, default=0)

    receives_government_assistance: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)

    housing_type: Mapped[str | None] = mapped_column(String(30), nullable=True)
