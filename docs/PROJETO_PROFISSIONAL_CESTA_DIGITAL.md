...
| 27/08/2026 | Sandbox local para homologação UX manual | O Frontend V2 completo foi iniciado em `finan002:5173` contra API `finan002:8010`, com SQLite persistente isolado e somente dados sintéticos. Login e cadastro de produto foram comprovados pela API real; Chromium percorreu 10/10 rotas desktop sem HTTP 500 ou erro de página e as mesmas 10 rotas em 390×844 sem overflow documental. Credencial e banco permanecem fora do Git. O ambiente está liberado apenas para avaliação UX local de Gabriel. |
