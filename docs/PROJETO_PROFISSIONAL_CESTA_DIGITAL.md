...
Próximo marco do frontend: `V2-07B`, implementar a aba Avaliações na branch
`feat/frontend-v2-avaliacoes` usando o contrato paginado aprovado localmente e a
referência 03. Etapas ilustrativas sem modelo real não serão simuladas.
