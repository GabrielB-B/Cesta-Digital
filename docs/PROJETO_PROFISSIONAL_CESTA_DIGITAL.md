...
Próximo gate: implementação e aprovação visual da aba Tipos de Cesta (`V2-11`)
com comparação da referência 07 em 390/768/1440. Relatórios (`V2-12`) não
avança antes dessa decisão.
