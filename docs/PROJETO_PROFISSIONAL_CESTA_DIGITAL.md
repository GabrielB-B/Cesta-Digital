...
| 26/08/2026 | Checkpoint local V2-12 — Relatórios proposto | Branch `feat/frontend-v2-relatorios` reproduz a referência 08 com período, três indicadores reais e seis exports CSV para administrador, além de composição própria em 360/390/768. O backend calcula famílias atendidas, cestas concluídas e unidades distribuídas; downloads são segmentados por papel, neutralizam fórmulas e registram auditoria. `/financial-summary` continua compatível por redirect e o endpoint anterior permanece intacto. Matriz passa a 28 paths, sem migration. Gates: backend 74/74, frontend lint/build, E2E 38/38 e visual 6 aprovados com 2 skips intencionais. Aguarda aprovação visual de Gabriel. |

Próximo gate: aprovação visual da aba Relatórios (`V2-12`) na galeria
comparativa em 390/768/1440. Administração (`V2-13`) não avança antes dessa
decisão.
